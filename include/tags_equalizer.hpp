...
constexpr char band_solo[][13] = {{"band0-solo"},  {"band1-solo"},  {"band2-solo"},  {"band3-solo"},  {"band4-solo"},
                                  {"band5-solo"},  {"band6-solo"},  {"band7-solo"},  {"band8-solo"},  {"band9-solo"},
                                  {"band10-solo"}, {"band11-solo"}, {"band12-solo"}, {"band13-solo"}, {"band14-solo"},
                                  {"band15-solo"}, {"band16-solo"}, {"band17-solo"}, {"band18-solo"}, {"band19-solo"},
                                  {"band20-solo"}, {"band21-solo"}, {"band22-solo"}, {"band23-solo"}, {"band24-solo"},
                                  {"band25-solo"}, {"band26-solo"}, {"band27-solo"}, {"band28-solo"}, {"band29-solo"},
                                  {"band30-solo"}, {"band31-solo"}};

constexpr char band_mute[][13] = {{"band0-mute"},  {"band1-mute"},  {"band2-mute"},  {"band3-mute"},  {"band4-mute"},
                                  {"band5-mute"},  {"band6-mute"},  {"band7-mute"},  {"band8-mute"},  {"band9-mute"},
                                  {"band10-mute"}, {"band11-mute"}, {"band12-mute"}, {"band13-mute"}, {"band14-mute"},
                                  {"band15-mute"}, {"band16-mute"}, {"band17-mute"}, {"band18-mute"}, {"band19-mute"},
                                  {"band20-mute"}, {"band21-mute"}, {"band22-mute"}, {"band23-mute"}, {"band24-mute"},
                                  {"band25-mute"}, {"band26-mute"}, {"band27-mute"}, {"band28-mute"}, {"band29-mute"},
...
constexpr char band_gain[][13] = {{"band0-gain"},  {"band1-gain"},  {"band2-gain"},  {"band3-gain"},  {"band4-gain"},
                                  {"band5-gain"},  {"band6-gain"},  {"band7-gain"},  {"band8-gain"},  {"band9-gain"},
                                  {"band10-gain"}, {"band11-gain"}, {"band12-gain"}, {"band13-gain"}, {"band14-gain"},
                                  {"band15-gain"}, {"band16-gain"}, {"band17-gain"}, {"band18-gain"}, {"band19-gain"},
                                  {"band20-gain"}, {"band21-gain"}, {"band22-gain"}, {"band23-gain"}, {"band24-gain"},
                                  {"band25-gain"}, {"band26-gain"}, {"band27-gain"}, {"band28-gain"}, {"band29-gain"},
...
constexpr char sl[][7] = {{"sl_0"},  {"sl_1"},  {"sl_2"},  {"sl_3"},  {"sl_4"},  {"sl_5"},  {"sl_6"},  {"sl_7"},
                          {"sl_8"},  {"sl_9"},  {"sl_10"}, {"sl_11"}, {"sl_12"}, {"sl_13"}, {"sl_14"}, {"sl_15"},
                          {"sl_16"}, {"sl_17"}, {"sl_18"}, {"sl_19"}, {"sl_20"}, {"sl_21"}, {"sl_22"}, {"sl_23"},
                          {"sl_24"}, {"sl_25"}, {"sl_26"}, {"sl_27"}, {"sl_28"}, {"sl_29"}, {"sl_30"}, {"sl_31"}};

constexpr char xsl[][8] = {{"xsl_0"},  {"xsl_1"},  {"xsl_2"},  {"xsl_3"},  {"xsl_4"},  {"xsl_5"},  {"xsl_6"},
...
constexpr char xml[][8] = {{"xml_0"},  {"xml_1"},  {"xml_2"},  {"xml_3"},  {"xml_4"},  {"xml_5"},  {"xml_6"},
...
constexpr char gl[][7] = {{"gl_0"},  {"gl_1"},  {"gl_2"},  {"gl_3"},  {"gl_4"},  {"gl_5"},  {"gl_6"},  {"gl_7"},
                          {"gl_8"},  {"gl_9"},  {"gl_10"}, {"gl_11"}, {"gl_12"}, {"gl_13"}, {"gl_14"}, {"gl_15"},
                          {"gl_16"}, {"gl_17"}, {"gl_18"}, {"gl_19"}, {"gl_20"}, {"gl_21"}, {"gl_22"}, {"gl_23"},
                          {"gl_24"}, {"gl_25"}, {"gl_26"}, {"gl_27"}, {"gl_28"}, {"gl_29"}, {"gl_30"}, {"gl_31"}};
...
constexpr char sr[][7] = {{"sr_0"},  {"sr_1"},  {"sr_2"},  {"sr_3"},  {"sr_4"},  {"sr_5"},  {"sr_6"},  {"sr_7"},
                          {"sr_8"},  {"sr_9"},  {"sr_10"}, {"sr_11"}, {"sr_12"}, {"sr_13"}, {"sr_14"}, {"sr_15"},
                          {"sr_16"}, {"sr_17"}, {"sr_18"}, {"sr_19"}, {"sr_20"}, {"sr_21"}, {"sr_22"}, {"sr_23"},
                          {"sr_24"}, {"sr_25"}, {"sr_26"}, {"sr_27"}, {"sr_28"}, {"sr_29"}, {"sr_30"}, {"sr_31"}};

constexpr char xsr[][8] = {{"xsr_0"},  {"xsr_1"},  {"xsr_2"},  {"xsr_3"},  {"xsr_4"},  {"xsr_5"},  {"xsr_6"},
...
constexpr char xmr[][8] = {{"xmr_0"},  {"xmr_1"},  {"xmr_2"},  {"xmr_3"},  {"xmr_4"},  {"xmr_5"},  {"xmr_6"},
...
constexpr char gr[][7] = {{"gr_0"},  {"gr_1"},  {"gr_2"},  {"gr_3"},  {"gr_4"},  {"gr_5"},  {"gr_6"},  {"gr_7"},
                          {"gr_8"},  {"gr_9"},  {"gr_10"}, {"gr_11"}, {"gr_12"}, {"gr_13"}, {"gr_14"}, {"gr_15"},
                          {"gr_16"}, {"gr_17"}, {"gr_18"}, {"gr_19"}, {"gr_20"}, {"gr_21"}, {"gr_22"}, {"gr_23"},
                          {"gr_24"}, {"gr_25"}, {"gr_26"}, {"gr_27"}, {"gr_28"}, {"gr_29"}, {"gr_30"}, {"gr_31"}};
