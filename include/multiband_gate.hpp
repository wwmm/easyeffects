...
class MultibandGate : public PluginBase {
   public:
    ...
    sigc::connection gating0_connection, gating1_connection, gating2_connection,
        gating3_connection;
    ...
    sigc::signal<void, double> gating0, gating1, gating2, gating3;
