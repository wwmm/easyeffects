...
void MultibandCompressorPreset::load(
    ...
    settings->set_double(
        "knee0",
        root.get<double>(section + ".multiband_compressor.subband.knee",
                         get_default<double>(settings, "knee0")));

    settings->set_string(
        "detection0", root.get<std::string>(
    ...
    settings->set_double(
        "knee1",
        root.get<double>(section + ".multiband_compressor.lowband.knee",
                         get_default<double>(settings, "knee1")));

    settings->set_string(
        "detection1", root.get<std::string>(
    ...
    settings->set_double(
        "knee2",
        root.get<double>(section + ".multiband_compressor.midband.knee",
                         get_default<double>(settings, "knee2")));

    settings->set_string(
        "detection2", root.get<std::string>(
    ...
    settings->set_double(
        "knee3",
        root.get<double>(section + ".multiband_compressor.highband.knee",
                         get_default<double>(settings, "knee3")));

    settings->set_string(
        "detection3", root.get<std::string>(
