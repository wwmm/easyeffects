...
void SinkInputEffectsUi::level_meters_connections() {
  ...
  connections.push_back(sie->multiband_gate->output_level.connect(sigc::mem_fun(
  ...
  connections.push_back(sie->autogain_input_level.connect(
      sigc::mem_fun(*autogain_ui, &AutoGainUi::on_new_input_level_db)));
  connections.push_back(sie->autogain_output_level.connect(
...
void SinkInputEffectsUi::up_down_connections() {
  ...
  connections.push_back(bass_enhancer_ui->plugin_down->signal_clicked().connect(
  ...
  connections.push_back(
      gate_ui->plugin_up->signal_clicked().connect([=]() { on_up(gate_ui); }));
  connections.push_back(gate_ui->plugin_down->signal_clicked().connect(
      [=]() { on_down(gate_ui); }));

  connections.push_back(multiband_gate_ui->plugin_up->signal_clicked().connect(
  ...
  connections.push_back(stereo_tools_ui->plugin_down->signal_clicked().connect(
  ...
  connections.push_back(autogain_ui->plugin_up->signal_clicked().connect(
      [=]() { on_up(autogain_ui); }));
