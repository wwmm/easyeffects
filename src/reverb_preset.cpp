...
void ReverbPreset::save(boost::property_tree::ptree& root,
    ...
    root.put(section + ".reverb.input-gain",
    ...
    root.put(section + ".reverb.decay-time",
             settings->get_double("decay-time"));
    ...
    root.put(section + ".reverb.treble-cut",
             settings->get_double("treble-cut"));
}
...
void ReverbPreset::load(boost::property_tree::ptree& root,
    ...
    settings->set_double(
        "dry", root.get<double>(section + ".reverb.dry",
                                get_default<double>(settings, "dry")));

    settings->set_double(
        "predelay",
        root.get<double>(section + ".reverb.predelay",
                         get_default<double>(settings, "predelay")));

    settings->set_double(
        "bass-cut",
        root.get<double>(section + ".reverb.bass-cut",
