        ...
        GridLayout {
            ...
            function createPluginStack(name, baseName, pluginDB) {
                ...
                const pluginMap = {
                    ...
                    [TagsPluginName.BaseName.crusher]: Qt.resolvedUrl("Crusher.qml"),
                    ...
                    [TagsPluginName.BaseName.immersiveSurround]: Qt.resolvedUrl("ImmersiveSurround.qml"),
                ...
                const packageMap = {
                    ...
                    [TagsPluginName.BaseName.crusher]: TagsPluginName.Package.calf,
                    ...
                    [TagsPluginName.BaseName.immersiveSurround]: TagsPluginName.Package.ee,
