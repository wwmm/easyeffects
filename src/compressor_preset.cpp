...
void CompressorPreset::save(nlohmann::json& json, const std::string& section) {
  ...
  json[section]["compressor"]["dry"] = g_settings_get_double(settings, "dry");

  json[section]["compressor"]["wet"] = g_settings_get_double(settings, "wet");
...
void CompressorPreset::load(const nlohmann::json& json, const std::string& section) {
